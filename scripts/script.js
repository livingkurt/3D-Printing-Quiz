...
// var questions_list = {1 : "What does FDM stand for when it refers to FDM 3D Printing?", 2 : "What part of the printer metls the plastic to be extruded?", 3 : "What is the most common filament type?", 4 : "Do you need a heated bed for all types of filaments?", 5 : "What is the most common nozzle size?"};
...
function start_quiz(event){
    ...
    // console.log("hello")
    question_num++
    title_h_e.innerHTML = "What does FDM stand for when it refers to FDM 3D Printing?";
